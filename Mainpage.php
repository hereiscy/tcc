...
<div class="content">
    <div class="welcome">
        <h2>Welcome to TWEET CAFE!</h2>
        <p>Please Login or Register now if u dont have an account</p>
        <p><a href="login.php">Login Now</a><a href="register.php">Register Now</a></p>
    </div>
